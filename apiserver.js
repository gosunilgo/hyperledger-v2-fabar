...
app.get('/api/queryallcars', async function (req, res) {
    try {
        ...
        const network = await gateway.getNetwork('healthcare');
...
app.post('/api/addcar/', async function (req, res) {
	...
	console.log(req.body);
        ...
        await contract.submitTransaction('createCar', req.body.carid, req.body.make,
			req.body.model, req.body.colour, req.body.owner);
